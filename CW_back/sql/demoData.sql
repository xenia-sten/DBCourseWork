...
$$
  ...
  BEGIN
    ...
    -- SELECT id FROM users WHERE name = 'Levi Manning' INTO user1_id;
    -- SELECT id FROM users WHERE name = 'Deanna Norton' INTO user2_id;
    INSERT INTO users_company (user_id, company_id) VALUES (1, curr_company);
...
$$
  ...
  BEGIN
    ...
    SELECT id FROM users WHERE name = 'Levi Manning' INTO user1_id;
    SELECT id FROM users WHERE name = 'Deanna Norton' INTO user2_id;
    INSERT INTO jobs (name, description, user_id) VALUES ('Старший мастер маникюра', 'Hhisdf', 1);
...
$$
  ...
  BEGIN
    ...
    SELECT id FROM users WHERE name = 'TestFront' INTO curr_user_id;
...
$$
  ...
  BEGIN
    ...
    SELECT id FROM service_template WHERE name = 'Наращивание' AND user_id = 1 INTO curr_template_id;
    ...
    VALUES (curr_company_id, 1, curr_template_id, curr_client_id, '2024-04-18 9:00');
    INSERT INTO visit (company_id, user_id, template_id, client_id, visit_date)
    VALUES (curr_company_id, 1, curr_template_id, curr_client_id, '2024-04-18 12:00');
    INSERT INTO visit (company_id, user_id, template_id, client_id, visit_date)
    VALUES (curr_company_id, 1, curr_template_id, curr_client_id, '2024-04-19 15:00');
  END
$$;
END;